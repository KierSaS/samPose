...
if __name__ == "__main__":
    ...
    pil_image = Image.open("/home/wubin/code/SamPose/data/demos/LINEMOD.png").convert('RGB')
    ...
    cv2.imwrite("/home/wubin/code/SamPose/data/demos/Linemoddino.png", heatmap_color)
