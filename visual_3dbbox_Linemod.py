...
if __name__  == "__main__":
    ...
    #####################
    prompt_filename = os.path.join("data/demo/Linemod", "19.png" )
    targe_filename = os.path.join("data/demo/Linemod", "40.png" )


    
    K0 = np.array(
        [[1.241841681355932451e+03,0.000000000000000000e+00,-9.923015593220338815e+01],
         [-8.208200796758758009e-14,1.244356187118644129e+03,2.940723850847457470e+02],
    ...
    x, y , z = 3.350535000000000319e-02, 6.381649999999999823e-02 ,5.872829999999999717e-02
    _3d_bbox = np.array([
        [-x, -y , -z],
        [-x, -y , z],
        [-x, y , z],
    ...
    prompt_pose = np.loadtxt(os.path.join("data/demo/Linemod", "19.txt" ))
    target_pose = np.loadtxt(os.path.join("data/demo/Linemod", "40.txt" ))
    ...
    our_bbox_img = draw_bbox_3d(target_image, pre_bbox_pts_3d,(255,0,0), thickness=0.01)
    # our_bbox_img = draw_axis(our_bbox_img,predict_pose[:3,:3], predict_pose[:3,3],K1,axis_length=2)
    cv2.imwrite(f"3D_BBox_cat.png",our_bbox_img)
