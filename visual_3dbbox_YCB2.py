...
if __name__  == "__main__":
    ...
    #####################
    prompt_filename = os.path.join("data/ycbv/0801-10-other/10-3/color", "1070-10.png" )#########################################
    targe_filename = os.path.join("data/ycbv/0801-10-other/10-3/color_full", "1280-10.png" )##############################


    file0_path = '/home/wubin/code/SamPose/data/ycbv/0801-10-other/10-3/intrin_ba/1070-10.txt'#############################
    K0 = load_intrinsic_matrix(file0_path)

    file1_path = '/home/wubin/code/SamPose/data/ycbv/0801-10-other/10-3/intrin/1280-10.txt'###########################
    K1 = load_intrinsic_matrix(file1_path)

    x, y , z = 54.444, 89.206, 18.335
    _3d_bbox = np.array([
        [-x, -y , -z],
        [-x, -y , z],
        [-x, y , z],
    ...
    prompt_pose = np.loadtxt(os.path.join("/home/wubin/code/SamPose/data/ycbv/0801-10-other/10-3/poses_ba", "1070-10.txt" ))###########################
    target_pose = np.loadtxt(os.path.join("/home/wubin/code/SamPose/data/ycbv/0801-10-other/10-3/poses_ba", "1280-10.txt" ))##########################
    ...
    directory = "/home/wubin/code/SamPose/data/ycbv/0801-10-other/10-3"
    save_path = os.path.join(directory, "3D_BBox1070-10-1280.png")####################################
