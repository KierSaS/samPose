...
_CN.LOFTR.RESNETFPN.BLOCK_DIMS = 128#这里我改了参数，原本这里是没有数值的

# 2. LoFTR-coarse module config
_CN.LOFTR.COARSE = CN()
_CN.LOFTR.COARSE.D_MODEL = 256*3
_CN.LOFTR.COARSE.D_FFN = 256*3
_CN.LOFTR.COARSE.NHEAD = 8*3
_CN.LOFTR.COARSE.LAYER_NAMES = ['self', 'cross'] * 4 * 3
...
_CN.LOFTR.FINE = CN()
_CN.LOFTR.FINE.D_MODEL = 128 * 3
_CN.LOFTR.FINE.D_FFN = 128 * 3
_CN.LOFTR.FINE.NHEAD = 8 * 3
_CN.LOFTR.FINE.LAYER_NAMES = ['self', 'cross'] * 1 * 3
